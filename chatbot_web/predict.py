...
class WordGloveChatBot(object):
    ...
    def __init__(self):
        ...
        self.target_word2idx = np.load(
            '../chatbot_train/models/' + DATA_SET_NAME + '/word-glove-target-word2idx.npy',allow_pickle=True).item()
        self.target_idx2word = np.load(
            '../chatbot_train/models/' + DATA_SET_NAME + '/word-glove-target-idx2word.npy',allow_pickle=True).item()
        context = np.load('../chatbot_train/models/' + DATA_SET_NAME + '/word-glove-context.npy',allow_pickle=True).item()
